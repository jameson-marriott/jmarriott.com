...
Let's start by looking at how many rolls it takes to win. We'll be usiing r, and this post assumes some familiarity with that language. Frst we'll load the tidyverse. 
...
Now we're ready to simulate rolling the dice a bunch of times. Just running the function a few times in the console, it looks like the average number of rolls that it takes to win will be somewhere from 7-9.
...
That took about 4 hours to compute on my laptop with an i7 and 8GB of RAM. That would be too long for a production environment, but for a one-time computation that's OK. I started it before I went to bed and it was ready in the morning. 
...
Let me know what improvements you see to this short excercise!